    ...
    try:
        ...
        for (
            ...
            if (
                ...
                print(
                    f"⚠️ Invalid Book DNA score "
                    f"for {category}: {score}"
                )
                return None
        ...
        if (
            set(reading_profile.keys())
            != expected_reading_profile
        ):
            print(
                "⚠️ Gemini returned invalid "
                "Reading Profile characteristics."
            )
            return None
...
"""
    ...
    try:
        ...
        if (
            ...
            print(
                "⚠️ Gemini unavailable while "
                "generating recommendation reason: "
                f"{error}"
            )
